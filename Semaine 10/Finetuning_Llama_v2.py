...
src = "../Data/Semaine_8/Batches_lama_512"
stories_train = 650
check_interval = 50
story_checkpoint = 100
batch_size = 1
chunk = 512   #Nombre de tokens par bloc

model = LlamaForCausalLM.from_pretrained("decapoda-research/llama-7b-hf", max_position_embeddings = chunk, load_in_8bit=True, device_map='auto', torch_dtype=torch.float16)
