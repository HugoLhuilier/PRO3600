...
data_path = "../Data/Semaine_10/Batches_lama_1024_purified/"
...
ptFiles = [torch.load(data_path + f + "/" + e) for f in os.listdir(data_path) for e in os.listdir(data_path + f)]
#data = load_dataset("json", data_files=data_path)
data = Dataset.from_list(ptFiles)
